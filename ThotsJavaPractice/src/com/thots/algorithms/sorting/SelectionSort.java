...
public class SelectionSort {
	...
	/**
	 * Base of this algorithm is a. Always find minimum element in the entire array
	 * and help it move to the sorted array's end b. At any point, elements from 0
	 * till i are always sorted.
	 * 
